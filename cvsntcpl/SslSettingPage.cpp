...
void CSslSettingPage::OnBnClickedSslcert()
{
	TCHAR fn[4096];
#ifdef JP_STRING
	OPENFILENAME ofn = { sizeof(OPENFILENAME), m_hWnd, NULL, _T("PEM 証明書 ファイル\0*.pem\0"), NULL, 0, 0, fn, sizeof(fn), NULL, 0, NULL, NULL, OFN_FILEMUSTEXIST|OFN_PATHMUSTEXIST|OFN_HIDEREADONLY, 0, 0, _T("pem") };
#else
